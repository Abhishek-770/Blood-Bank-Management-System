...
class _AdminScreenState extends State<AdminScreen> {
  ...
  void update(){
    ...
    FirebaseFirestore.instance.collection('Blood_Collection').doc('document_id').update({'A+': aPos,
    'A-':aNeg,'AB+':abPos,'AB-':abNeg,'B+':bPos,'B-':bNeg,'O+':oPos,'O-':oNeg
    });
  }
  @override
       ...
       title: Text(
         ...
         body: Padding(
           ...
           child: ListView(
             ...
             children:<Widget> [
               blood_updater(controller: aPosController,detail: "units of A+ blood"),
               blood_updater(controller: aNegController,detail:"units of A- blood" ,),
              blood_updater(controller: abPosController,detail: "units of AB+ blood",),
              blood_updater(controller: abNegController,detail: "units of AB- blood",),
              blood_updater(controller: bPosController,detail:"units of B+ blood" ,),
              blood_updater(controller: bNegController,detail:"units of B- blood" ,),
              blood_updater(controller: oPosController,detail: "units of O+ blood",),
              blood_updater(controller: oNegController,detail:"units of O- blood" ,),
