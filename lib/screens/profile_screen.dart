...
if(name!="" && age!="" && location!="" && bloodGroup!="" && phoneNumber!=""){
        ...
        child: Column(
         ...
         crossAxisAlignment: CrossAxisAlignment.stretch,
          children: <Widget>[
             ...
             ProfileMaker( controller: nameController,detail: 'Enter Your Name Here',),
             ProfileMaker(controller: ageController,detail: 'Enter Your Age Here',),
            ProfileMaker(controller: locationController,detail: 'Enter Your District Here',),
            ProfileMaker(controller: bloodGroupController,detail: 'Enter Your Blood_Group Here',),
            ProfileMaker(controller: phoneNumberController,detail: 'Enter Your Phone_Number Here',),
            Flexible(
              child: RoundedButton(title: "SAVE",
