...
Future<bool> f() async{
  print(value);
QuerySnapshot snapshot=await FirebaseFirestore.instance.collection('Blood_Collection').get();
          ...
          Container(
            ...
            onChanged: (value)=>setState(()  {
             ...
             hint: const Text(
              ...
              RoundedButton(title: "Request",
                  colour: Colors.blueAccent, onPressed : ()async {
                    res= await f();

                    if(res==true) {
                      ans="available,you can collect it from our nearest center";
                    } else {
